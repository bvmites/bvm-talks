...
$(document).ready(function () {
    ...
    $('.slider--prev, .slider--next').click(function () {
      ...
      setTimeout(function () {
        ...
        if ($this.hasClass('slider--next')) {
          if (curLeftPos < totalWorks - 1 && curCenterPos < totalWorks - 1 &&
  ...
  window.onhashchange = function (hashChangeEvent) {
    var oldURL = hashChangeEvent.oldURL;
    var newURL = hashChangeEvent.newURL;
    var oldHash = oldURL.slice(oldURL.lastIndexOf('#')).slice(1);
    var newHash = newURL.slice(newURL.lastIndexOf('#')).slice(1);
    var totalItems = $('.side-nav li').parent().children().length;
